...
This module provides the core menu management infrastructure for the Ottotone
application. It implements a component-based architecture that allows different
parts of the application to contribute to the menubar interface independently.

The MenuManager class serves as the central coordinator, while the BaseMenuComponent
class provides a foundation for specialized menu components like ModelMenu,
OutputMenu, and SettingsMenu.

This design enables a modular, maintainable approach to building the application's
user interface and ensures clear separation of concerns between different
